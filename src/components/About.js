    ...
    <div className="about">
      ...
      <div className="about-content">
        ...
        <h2>About Me</h2>
          ...
          <p>
            Prior to being a product manager, I was a Product Operations Manager where I led product rollouts, and supported product development through data analysis and user research. I completed a web development bootcamp in 2020 and have built on the skills to launch both web and mobile apps (see TrainGang.com, Archie AI mobile app). In my free time, I've enjoyed ultra-running, and have used the long training runs to cover <a href="https://gothamist.com/news/who-runs-new-york-this-guy-and-a-few-others-walked-it-too" target="_blank" rel="noopener noreferrer" className="inline-link">every street in Manhattan</a>.
          </p>
          <p>
